...
public class EditLibrarianTest extends ApplicationTest {
    ...
    public void checkLibrariansTry() throws TimeoutException, InterruptedException, IOException {
        ...
        robot.clickOn(salary).write("600");
        
        robot.clickOn((Button) lookup("#bttSubmit").query());
        Thread.sleep(1000);

        assertEquals("Success!",((TextField) lookup("#libLoginWarning").query()).getText());
//
